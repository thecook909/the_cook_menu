...
const menuItems = {
    ...
    "Chicken Sub Sandwich":"ساندويش دجاج ساب",
     "french fries, lettuce, pickles, the CooK's sauce, garlic paste":"بطاطا مقلية، خس، مخللات، صلصة ذا كوك، معجون الثوم",
...
const menuItemsArabic = {
    ...
    "ساندويش دجاج ساب":"Chicken Sub Sandwich",
    "بطاطا مقلية، خس، مخللات، صلصة ذا كوك، معجون الثوم":"french fries, lettuce, pickles, the CooK's sauce, garlic paste",
